...
CLIENT_SRC = $(SRC_DIR)/sdmessage.pb-c.c $(SRC_DIR)/network_client.c $(SRC_DIR)/client_stub.c  $(SRC_DIR)/table_client.c $(SRC_DIR)/message.c $(SRC_DIR)/stats.c $(SRC_DIR)/synchronization.c
CLIENT_OBJ = $(patsubst $(SRC_DIR)%.c,$(OBJ_DIR)%.o,$(CLIENT_SRC))

# Fontes e objetos do servidor
SERVER_SRC = $(SRC_DIR)/sdmessage.pb-c.c $(SRC_DIR)/network_server.c $(SRC_DIR)/table_skel.c  $(SRC_DIR)/table_server.c $(SRC_DIR)/message.c $(SRC_DIR)/stats.c $(SRC_DIR)/synchronization.c
